...
void mouseMoved() {
  ...
  OscMessage myMessage = new OscMessage("/composition/layers/1/video/effects/transform/positionx");
  ...
  myMessage.setAddrPattern("/composition/layers/1/video/effects/transform/positiony");
